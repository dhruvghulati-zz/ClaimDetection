...
# Sentence construct feature via a scikitlearn feature extract, MAPE for costs, use as input for classificier - costcla - C+ positive MAPE, C- negative MAPE
#     scikitlearn feature extraction - bag of word feature extractor - counts, currencies, doesnt matter.
    ...
    for sentence in parsedSentences:
        ...
        for locationTokenIDs, location in tokenIDs2location.items():
            ...
            if region in property2region2value[property]:  
                ...
                # For for all the numbers mentioned
