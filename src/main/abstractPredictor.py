...
class AbstractPredictor(object):
    def __init__(self):
        pass
    # This is about loading the Freebase file
    @staticmethod
    ...
    def train(self, trainMatrix, textMatrix, params):
        pass
    # You are predicting the property and region, not the value?
    def predict(self, property, region):
        pass
         
    @classmethod
    def runRelEval(cls, d, property, trainRegion2value, textMatrix, testRegion2value, ofn, params):
        # http://stackoverflow.com/questions/12179271/python-classmethod-and-staticmethod-for-beginner defining an overloaded function in python
        predictor = cls()
        of = open(ofn, "w")
        print "Training"
    ...
    def eval(predMatrix, testMatrix, of):
        ...
        for property, predRegion2value in predMatrix.items():
            of.write(property+"\n")
            # The real value is not from Freebase but what is stored
            print "real: ", testMatrix[property]
            print "predicted: ", predRegion2value
            of.write("real: "+ str(testMatrix[property])+"\n")
            of.write("predicted: " + str(predRegion2value)+"\n")
