...
# We distinguish between the two by re- quiring each region-pattern combination to have appeared at least twice and its values to have standard deviation less than 0.1. In this case, then the region-pattern value is set to the mean of the val- ues it is encountered with, otherwise is removed.



# python matrixFiltering.py data/output/mainMatrix.json data/aliases.json data/theMatrixExtend120TokenFiltered_2_2_0.1_0.5_fixed2.json 2 2 0.1 ?
