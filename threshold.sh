...
python src/main/naiveBaselines.py data/output/predictedPropertiesZero.json data/output/devLabels.json data/featuresKept.json data/output/zero/test1/ data/output/zero/test1/summaryEvaluation.csv
...
do
      ...
      python src/main/logisticBagOfWords.py data/output/predictedPropertiesZero.json data/output/devLabels.json data/featuresKept.json data/output/zero/test1/ data/output/zero/test1/summaryEvaluation.csv
      for prob in "${probThreshold[@]}";
      do
          python src/main/probPredictor.py data/output/zero/test1/ $prob data/output/zero/test/models.json data/output/zero/test1/summaryEvaluation.csv
      done
done
