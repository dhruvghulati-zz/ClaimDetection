...
do
      ...
      for prob in "${probThreshold[@]}";
        do
      python src/main/logisticBagOfWords.py data/output/predictedProperties.json data/output/devLabels.json data/featuresKept.json data/output/ data/output/test/summaryEval.csv $var
        done
