...
#       python src/main/logisticBagOfWords2.py data/output/predictedProperties.json data/output/hyperTestLabels.json data/featuresKept.json data/output/features data/output/features/summaryEvaluationTest.csv
#       for prob in "${probThreshold[@]}";
#       do
#           python src/main/probPredictor.py data/output/features data/output/features/summaryEvaluationTest.csv $prob
#       done
...
python src/main/logisticBagOfWords2.py data/output/predictedProperties.json data/output/hyperTestLabels.json data/featuresKept.json data/output/features data/output/features/summaryEvaluationTest.csv
python src/main/probPredictor.py data/output/features data/output/features/summaryEvaluationTest.csv 0.05
