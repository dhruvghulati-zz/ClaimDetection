...
for var in "${threshold[@]}"; do
      python src/main/propertyPredictor.py data/freebaseTriples.json data/sentenceMatrixFiltered.json data/output/predictedProperties.json $var
      ...
      python src/main/logisticBagOfWords.py data/output/predictedProperties.json data/output/hyperTestLabels.json data/featuresKept.json data/output/evaluation.txt data/output/ data/output/summaryEval.csv
